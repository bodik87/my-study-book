...
export default function MobileYouTube() {
  ...
  return (
    <main className="flex max-h-screen h-full max-w-maximum mx-auto bg-white flex-col items-center select-none relative overflow-hidden">
      ...
      <div
        ...
        } fixed w-full max-h-[75%] max-w-maximum h-full p-4 bg-myBlue rounded-t-2xl transition-all duration-300 z-10`}
      >
        <div className="h-full flex flex-col">
          ...
          <div className="h-full overflow-y-auto">
            <div className="h-[1000px] gradient">
